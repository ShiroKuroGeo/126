                    ...
                    <div class="card shadow">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    <?php
                                    $ret = "SELECT rp.*, rs.staff_name, rc.customer_name FROM rpos_payments as rp INNER JOIN rpos_staff as rs INNER JOIN rpos_customers as rc ORDER BY `created_at` DESC";
