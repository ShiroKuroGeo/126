                ...
                <a href="orders_reports.php">
                  <div class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <h5 class="card-title text-uppercase text-muted mb-0"><?php echo date('F', strtotime('last month')); ?></h5>
                          <span class="h2 font-weight-bold mb-0"><?php echo $monthLast; ?></span>
                        </div>
                        <div class="col-auto">
                ...
                <a href="orders_reports.php">
                  <div class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <h5 class="card-title text-uppercase text-muted mb-0"><?php echo date('F'); ?></h5>
                          <span class="h2 font-weight-bold mb-0"><?php echo $monthNow; ?></span>
                        </div>
                        <div class="col-auto">
                          <div class="icon icon-shape bg-info text-white rounded-circle shadow">
                            <i class="fas fa-calendar"></i>
