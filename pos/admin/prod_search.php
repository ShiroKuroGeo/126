...
if(isset($_POST['delete']))
{
    ...
    if ($query_run) 
    {
          $success = "Deleted" && header("refresh:1; url=prod_search.php");
    } 
    else 
    {
          $err = "Try Again Later";
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  if(isset($_GET['search']))
                  {
                    ...
                    $query = "SELECT * FROM rpos_products WHERE CONCAT(prod_code,prod_name,prod_category,prod_price) LIKE '%$filtervalues%' ";
                    $query_run = mysqli_query($con, $query);
