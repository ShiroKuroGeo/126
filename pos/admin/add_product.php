...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST["prod_category"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price'])) {
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" readonly name="prod_code" value="<?php echo $alpha; ?>-<?php echo $beta; ?>" class="form-control" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
                  <!-- <div class="col-md-3">
                    ...
                    <input type="number" name="prod_origpr" class="form-control" required value="">
                  </div>
                  <div class="col-md-3">
                    <label>Revenue</label>
                    <input type="number" name="prod_revenue" class="form-control" required value="">
                  </div> -->

                  <div class="col-md-4">
                    <label>Product Image</label>
                    <input type="file" name="prod_img" class="btn btn-outline-success form-control" required value="">
                  </div>
                  <div class="col-md-4">
                    <label>Product Category</label>
                    <input type="text" name="prod_category" class="form-control" required value="">
                  </div>
                  <div class="col-md-4">
                    <label>Product Price</label>
                    <input type="number" name="prod_price" class="form-control" required value="">
                  </div>
                  
                  <!-- <div class="col-md-6">
                    <label>Product Quantity</label>
                    <input type="number" name="prod_quantity" class="form-control" required value="">
                  </div> -->
                </div>
                <hr>
                <div class="form-row">
