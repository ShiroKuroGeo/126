...
<body class="bg-dark col">
    <a href="../../index.php" class="btn btn-outline-success px-4 my-4 mx-2">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">126 Motor Parts</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card bg-secondary shadow border-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <form method="post" role="form">
                                ...
                                <div class="form-group">
                                    <div class="text-left">
                                        <button type="submit" name="addCustomer" class="btn btn-primary my-4 ml-4">Create Account</button>
                                        <a href="index.php" class=" btn btn-success pull-right ml-2">Log In</a>
                                    </div>
                                </div>
                            </form>
