...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="../admin/assets/img/icons/favicon0-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../admin/assets/img/icons/favicon0-16x16.png">
                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>126 Motor Parts</strong>
                                <br>
                                Front of 3M Electronix, Lapu-Lapu City
                                <br>
                                7XP9+9JF, Andrew Loable, Lapu-Lapu City, 6015 Cebu(Beside of PTT)
                                <br>
                                (032) 266 5793
                            </address>
                        </div>
