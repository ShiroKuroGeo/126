                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            ...
                            <p class="text-white mt-0 mb-5">This is your profile page. You can customize your profile as you want And also change password tooWelcome to 126 Motor Parts. we are passionate about all things motors. Our goal is to provide you with high-quality motor parts and accessories to enhance your vehicle's performance and reliability. Whether you're a car enthusiast, a professional mechanic, or simply looking for replacement parts, we've got you covered.</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" id="input-email" name="ChangeProfile" class="btn btn-success form-control-alternative" value="Update">
                                                        </div>
                                                        </div>
                                                    </div>
                                                    </div>
